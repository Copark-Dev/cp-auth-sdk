...
const DEFAULT_JWKS_URL = "https://oefybpntdguqyjrhurng.supabase.co/auth/v1/.well-known/jwks.json";
const DEFAULT_AUDIENCE = "authenticated";
let cachedVerifier = null;
let cachedKey = null;
function getVerifier(jwksUrl) {
    if (cachedKey === jwksUrl && cachedVerifier)
 ...
 */
export async function verifyCpJwt(token, opts = {}) {
